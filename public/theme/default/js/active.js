;(function ($) {
  ...
  $(document).on('ready', function () {
    ...
    $('.quantity-right-plus-one').on('click', function () {
      var $qty = $('.input-number-one')
      var currentVal = parseInt($qty.val(), 10)
      if (!isNaN(currentVal)) {
        $qty.val(currentVal + 1)
      }
    })
    $('.quantity-left-minus-one').on('click', function () {
      var $qty = $('.input-number-one')
      var currentVal = parseInt($qty.val(), 10)
      if (!isNaN(currentVal) && currentVal > 1) {
        $qty.val(currentVal - 1)
    ...
    $('.quantity-right-plus-two').on('click', function () {
      var $qty = $('.input-number-two')
      var currentVal = parseInt($qty.val(), 10)
      if (!isNaN(currentVal)) {
        $qty.val(currentVal + 1)
      }
    })
    $('.quantity-left-minus-two').on('click', function () {
      var $qty = $('.input-number-two')
      var currentVal = parseInt($qty.val(), 10)
      if (!isNaN(currentVal) && currentVal > 1) {
        $qty.val(currentVal - 1)
