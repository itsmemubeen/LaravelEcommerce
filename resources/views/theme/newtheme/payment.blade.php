						...
						<div class="content">
							<div class="button" id="payment-button">
								<div id="paypal-container" class="d-none">
									@include('theme.newtheme.gateways.paypal')
								</div>

								<div id="stripe-container" class="d-none">
									@include('theme.newtheme.gateways.stripe')
								</div>

								<div id="razorpay-container" class="d-none">
									@include('theme.newtheme.gateways.razorpay')
								</div>

								<div id="paystack-container" class="d-none">
									@include('theme.newtheme.gateways.paystack')
								</div>
